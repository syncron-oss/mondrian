...
public class MondrianProperties extends MondrianPropertiesBase {
    ...
    /**
     * Whether db connection should only use current schema.
     */
    public transient final BooleanProperty JdbcSchemaLimitSearch =
        new BooleanProperty(
            this, "mondrian.jdbcSchemaLimitSearch", false);
    ...
    /**
     * <p>Property that defines the interval value (in miliseconds) between
     ...
     * as expected. Defaults to 1000ms.</p>
     */
    public transient final IntegerProperty RolapConnectionShepherdThreadPollingInterval =
        new IntegerProperty(
            this, "mondrian.rolap.shepherdThreadPollingInterval", 1000);

    /**
     * Property which defines how many threads are created in order to
     * analyze possible segment rollup opportunities. This value defaults
     * to 4, but it can be set to a higher value on big multi-core systems.
     */
    public transient final IntegerProperty RollupAnalyzerNumberThreads =
        new IntegerProperty(
     ...
     *
     * <p>Default value is 3000 milliseconds (3 seconds).</p>
     *
     * <p>See also
